...
namespace FaultTrage_Test2.Controllers
{
    public class DesignationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DesignationId,Designation1")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DesignationId,Designation1")] Designation designation)
        {
            if (ModelState.IsValid)
            {
